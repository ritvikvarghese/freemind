...
export const AGENT_MODES: { id: AgentMode; label: string; hint: string }[] = [
  {
    id: "freeform",
    label: "Freeform",
    hint: "Your prompt drives the format. Summarize, synthesize, compare — whatever you write.",
  },
  {
    id: "deepsynth",
    label: "Deepsynth",
...
**Alternatives considered** — short list of the other directions you weighed and the specific reason each lost.
